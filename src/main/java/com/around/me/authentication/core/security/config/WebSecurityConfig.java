package com.around.me.authentication.core.security.config;
...
import com.around.me.authentication.core.security.filter.JwtAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .and()
                .addFilterBefore(new JwtAuthenticationFilter(customUserDetailService, jwtTokenProvider, cookieUtil, redisUtil)
